...
\includegraphics[width=0.4\linewidth]{ABC_home.jpg}
\begin{enumerate}
    \item Install the \textbf{Arduino Bluetooth Controller} app from the Google Play Store.
    \item Upload

Ajay krishna DM, [23-10-2025 14:56]
the voice‑control code tothe ESP32 using PlatformIO.
